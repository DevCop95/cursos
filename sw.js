...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v44',
  './css/app.css?v=dev101x-v44',
  './js/main.js?v=dev101x-v44',
  './js/identicon.js?v=dev101x-v44',
  './js/water-reveal.js?v=dev101x-v44',
  './js/config.js?v=dev101x-v44',
  './js/state.js?v=dev101x-v44',
  './js/router.js?v=dev101x-v44',
  './js/auth.js?v=dev101x-v44',
  './js/cloud.js?v=dev101x-v44',
  './js/progress.js?v=dev101x-v44',
  './js/lab.js?v=dev101x-v44',
  './js/content.js?v=dev101x-v44',
  './js/search.js?v=dev101x-v44',
  './js/ui.js?v=dev101x-v44',
  './js/lib/html.js?v=dev101x-v44',
  './js/lib/jwt.js?v=dev101x-v44',
  './js/lib/activity.js?v=dev101x-v44',
  './js/lib/badges.js?v=dev101x-v44',
  './js/lib/access.js?v=dev101x-v44',
  './js/lib/course-engine.js?v=dev101x-v44',
  './js/views/course-aula.js?v=dev101x-v44',
  './js/lib/cmd-history.js?v=dev101x-v44',
  './js/views/login.js?v=dev101x-v44',
  './js/views/courses.js?v=dev101x-v44',
  './js/views/aula.js?v=dev101x-v44',
  './js/views/perfil.js?v=dev101x-v44',
  './js/views/admin.js?v=dev101x-v44',
  './assets/icon-192.png',
  './assets/favicon.png',
