...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v51',
  './css/app.css?v=dev101x-v51',
  './js/main.js?v=dev101x-v51',
  './js/identicon.js?v=dev101x-v51',
  './js/water-reveal.js?v=dev101x-v51',
  './js/config.js?v=dev101x-v51',
  './js/state.js?v=dev101x-v51',
  './js/router.js?v=dev101x-v51',
  './js/auth.js?v=dev101x-v51',
  './js/cloud.js?v=dev101x-v51',
  './js/progress.js?v=dev101x-v51',
  './js/lab.js?v=dev101x-v51',
  './js/content.js?v=dev101x-v51',
  './js/search.js?v=dev101x-v51',
  './js/ui.js?v=dev101x-v51',
  './js/lib/html.js?v=dev101x-v51',
  './js/lib/jwt.js?v=dev101x-v51',
  './js/lib/activity.js?v=dev101x-v51',
  './js/lib/badges.js?v=dev101x-v51',
  './js/lib/access.js?v=dev101x-v51',
  './js/lib/course-engine.js?v=dev101x-v51',
  './js/lib/upcoming.js?v=dev101x-v51',
  './assets/shodan.png',
  './js/views/course-aula.js?v=dev101x-v51',
  './js/views/resume.js?v=dev101x-v51',
  './js/views/messages.js?v=dev101x-v51',
  './js/lib/cmd-history.js?v=dev101x-v51',
  './js/views/login.js?v=dev101x-v51',
  './js/views/courses.js?v=dev101x-v51',
  './js/views/aula.js?v=dev101x-v51',
  './js/views/perfil.js?v=dev101x-v51',
  './js/views/admin.js?v=dev101x-v51',
  './assets/icon-192.png',
  './assets/favicon.png',
