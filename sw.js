...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v27',
  './css/app.css?v=dev101x-v27',
  './js/main.js?v=dev101x-v27',
  './js/identicon.js?v=dev101x-v27',
  './js/water-reveal.js?v=dev101x-v27',
  './js/config.js',
  './js/state.js',
  './js/router.js',
  './js/auth.js',
