...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v30',
  './css/app.css?v=dev101x-v30',
  './js/main.js?v=dev101x-v30',
  './js/identicon.js?v=dev101x-v30',
  './js/water-reveal.js?v=dev101x-v30',
  './js/config.js',
  './js/state.js',
  './js/router.js',
  './js/auth.js',
