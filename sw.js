...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v48',
  './css/app.css?v=dev101x-v48',
  './js/main.js?v=dev101x-v48',
  './js/identicon.js?v=dev101x-v48',
  './js/water-reveal.js?v=dev101x-v48',
  './js/config.js?v=dev101x-v48',
  './js/state.js?v=dev101x-v48',
  './js/router.js?v=dev101x-v48',
  './js/auth.js?v=dev101x-v48',
  './js/cloud.js?v=dev101x-v48',
  './js/progress.js?v=dev101x-v48',
  './js/lab.js?v=dev101x-v48',
  './js/content.js?v=dev101x-v48',
  './js/search.js?v=dev101x-v48',
  './js/ui.js?v=dev101x-v48',
  './js/lib/html.js?v=dev101x-v48',
  './js/lib/jwt.js?v=dev101x-v48',
  './js/lib/activity.js?v=dev101x-v48',
  './js/lib/badges.js?v=dev101x-v48',
  './js/lib/access.js?v=dev101x-v48',
  './js/lib/course-engine.js?v=dev101x-v48',
  './js/lib/upcoming.js?v=dev101x-v48',
  './assets/shodan.png',
  './js/views/course-aula.js?v=dev101x-v48',
  './js/lib/cmd-history.js?v=dev101x-v48',
  './js/views/login.js?v=dev101x-v48',
  './js/views/courses.js?v=dev101x-v48',
  './js/views/aula.js?v=dev101x-v48',
  './js/views/perfil.js?v=dev101x-v48',
  './js/views/admin.js?v=dev101x-v48',
  './assets/icon-192.png',
  './assets/favicon.png',
