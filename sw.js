...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v31',
  './css/app.css?v=dev101x-v31',
  './js/main.js?v=dev101x-v31',
  './js/identicon.js?v=dev101x-v31',
  './js/water-reveal.js?v=dev101x-v31',
  './js/config.js',
  './js/state.js',
  './js/router.js',
  './js/auth.js',
