...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v50',
  './css/app.css?v=dev101x-v50',
  './js/main.js?v=dev101x-v50',
  './js/identicon.js?v=dev101x-v50',
  './js/water-reveal.js?v=dev101x-v50',
  './js/config.js?v=dev101x-v50',
  './js/state.js?v=dev101x-v50',
  './js/router.js?v=dev101x-v50',
  './js/auth.js?v=dev101x-v50',
  './js/cloud.js?v=dev101x-v50',
  './js/progress.js?v=dev101x-v50',
  './js/lab.js?v=dev101x-v50',
  './js/content.js?v=dev101x-v50',
  './js/search.js?v=dev101x-v50',
  './js/ui.js?v=dev101x-v50',
  './js/lib/html.js?v=dev101x-v50',
  './js/lib/jwt.js?v=dev101x-v50',
  './js/lib/activity.js?v=dev101x-v50',
  './js/lib/badges.js?v=dev101x-v50',
  './js/lib/access.js?v=dev101x-v50',
  './js/lib/course-engine.js?v=dev101x-v50',
  './js/lib/upcoming.js?v=dev101x-v50',
  './assets/shodan.png',
  './js/views/course-aula.js?v=dev101x-v50',
  './js/views/resume.js?v=dev101x-v50',
  './js/lib/cmd-history.js?v=dev101x-v50',
  './js/views/login.js?v=dev101x-v50',
  './js/views/courses.js?v=dev101x-v50',
  './js/views/aula.js?v=dev101x-v50',
  './js/views/perfil.js?v=dev101x-v50',
  './js/views/admin.js?v=dev101x-v50',
  './assets/icon-192.png',
  './assets/favicon.png',
