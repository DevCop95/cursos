...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v26',
  './css/app.css?v=dev101x-v26',
  './js/main.js?v=dev101x-v26',
  './js/identicon.js?v=dev101x-v26',
  './js/water-reveal.js?v=dev101x-v26',
  './js/config.js',
  './js/state.js',
  './js/router.js',
  './js/auth.js',
