...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v49',
  './css/app.css?v=dev101x-v49',
  './js/main.js?v=dev101x-v49',
  './js/identicon.js?v=dev101x-v49',
  './js/water-reveal.js?v=dev101x-v49',
  './js/config.js?v=dev101x-v49',
  './js/state.js?v=dev101x-v49',
  './js/router.js?v=dev101x-v49',
  './js/auth.js?v=dev101x-v49',
  './js/cloud.js?v=dev101x-v49',
  './js/progress.js?v=dev101x-v49',
  './js/lab.js?v=dev101x-v49',
  './js/content.js?v=dev101x-v49',
  './js/search.js?v=dev101x-v49',
  './js/ui.js?v=dev101x-v49',
  './js/lib/html.js?v=dev101x-v49',
  './js/lib/jwt.js?v=dev101x-v49',
  './js/lib/activity.js?v=dev101x-v49',
  './js/lib/badges.js?v=dev101x-v49',
  './js/lib/access.js?v=dev101x-v49',
  './js/lib/course-engine.js?v=dev101x-v49',
  './js/lib/upcoming.js?v=dev101x-v49',
  './assets/shodan.png',
  './js/views/course-aula.js?v=dev101x-v49',
  './js/lib/cmd-history.js?v=dev101x-v49',
  './js/views/login.js?v=dev101x-v49',
  './js/views/courses.js?v=dev101x-v49',
  './js/views/aula.js?v=dev101x-v49',
  './js/views/perfil.js?v=dev101x-v49',
  './js/views/admin.js?v=dev101x-v49',
  './assets/icon-192.png',
  './assets/favicon.png',
