...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v29',
  './css/app.css?v=dev101x-v29',
  './js/main.js?v=dev101x-v29',
  './js/identicon.js?v=dev101x-v29',
  './js/water-reveal.js?v=dev101x-v29',
  './js/config.js',
  './js/state.js',
  './js/router.js',
  './js/auth.js',
