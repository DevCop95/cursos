...
const PRECACHE = [
  ...
  './index.html',
  './manifest.json',
  './css/tailwind.css?v=dev101x-v47',
  './css/app.css?v=dev101x-v47',
  './js/main.js?v=dev101x-v47',
  './js/identicon.js?v=dev101x-v47',
  './js/water-reveal.js?v=dev101x-v47',
  './js/config.js?v=dev101x-v47',
  './js/state.js?v=dev101x-v47',
  './js/router.js?v=dev101x-v47',
  './js/auth.js?v=dev101x-v47',
  './js/cloud.js?v=dev101x-v47',
  './js/progress.js?v=dev101x-v47',
  './js/lab.js?v=dev101x-v47',
  './js/content.js?v=dev101x-v47',
  './js/search.js?v=dev101x-v47',
  './js/ui.js?v=dev101x-v47',
  './js/lib/html.js?v=dev101x-v47',
  './js/lib/jwt.js?v=dev101x-v47',
  './js/lib/activity.js?v=dev101x-v47',
  './js/lib/badges.js?v=dev101x-v47',
  './js/lib/access.js?v=dev101x-v47',
  './js/lib/course-engine.js?v=dev101x-v47',
  './js/views/course-aula.js?v=dev101x-v47',
  './js/lib/cmd-history.js?v=dev101x-v47',
  './js/views/login.js?v=dev101x-v47',
  './js/views/courses.js?v=dev101x-v47',
  './js/views/aula.js?v=dev101x-v47',
  './js/views/perfil.js?v=dev101x-v47',
  './js/views/admin.js?v=dev101x-v47',
  './assets/icon-192.png',
  './assets/favicon.png',
