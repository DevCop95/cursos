...
import { appState, saveState } from '../state.js?v=dev101x-v68';
import { currentProgress, currentSteps, fetchStreak } from '../progress.js?v=dev101x-v68';
import { computeBadges } from '../lib/badges.js?v=dev101x-v68';
import { avatarFor, openDialog, closeModal, showToast } from '../ui.js?v=dev101x-v68';
import { checkDisplayName } from '../lib/display-name.js?v=dev101x-v68';
import { isAdmin } from '../auth.js?v=dev101x-v68';
import { fetchCourseProgress, fetchCourses, fetchAccessibleCourses, fetchUserStats, setDisplayName } from '../cloud.js?v=dev101x-v68';
import { rankView, courseIcon } from '../lib/ranks.js?v=dev101x-v68';
import { COURSE } from '../content.js?v=dev101x-v68';
import { paintResume } from './resume.js?v=dev101x-v68'; // curso de Nmap: su progreso vive en progress.js
