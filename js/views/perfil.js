...
import { currentProgress, currentSteps, fetchStreak } from '../progress.js?v=dev101x-v46';
import { computeBadges } from '../lib/badges.js?v=dev101x-v46';
import { avatarFor, openDialog } from '../ui.js?v=dev101x-v46';
import { isAdmin } from '../auth.js?v=dev101x-v46';
import { fetchCourseProgress, fetchCourses, fetchAccessibleCourses } from '../cloud.js?v=dev101x-v46';
import { COURSE } from '../content.js?v=dev101x-v46'; // curso de Nmap: su progreso vive en progress.js
