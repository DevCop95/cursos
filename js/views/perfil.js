...
import { currentProgress, currentSteps, fetchStreak } from '../progress.js?v=dev101x-v54';
import { computeBadges } from '../lib/badges.js?v=dev101x-v54';
import { avatarFor, openDialog } from '../ui.js?v=dev101x-v54';
import { isAdmin } from '../auth.js?v=dev101x-v54';
import { fetchCourseProgress, fetchCourses, fetchAccessibleCourses, fetchUserStats } from '../cloud.js?v=dev101x-v54';
import { rankView, courseIcon } from '../lib/ranks.js?v=dev101x-v54';
import { COURSE } from '../content.js?v=dev101x-v54';
import { paintResume } from './resume.js?v=dev101x-v54'; // curso de Nmap: su progreso vive en progress.js
