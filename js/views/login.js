 ...
 */
import { CONFIG, isCloudEnabled } from '../config.js?v=dev101x-v43';
import { COURSE, COURSE_VIDEO } from '../content.js?v=dev101x-v43';
import { prepareNonce, signInWithGoogleCredential, startGoogleLogin, getLastAccount, forgetLastAccount } from '../auth.js?v=dev101x-v43';
import { esc } from '../lib/html.js?v=dev101x-v43';
import { avatarFor, showToast } from '../ui.js?v=dev101x-v43';
