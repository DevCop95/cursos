 ...
 */
import { CONFIG, isCloudEnabled } from '../config.js?v=dev101x-v73';
import { COURSE, COURSE_VIDEO } from '../content.js?v=dev101x-v73';
import { prepareNonce, signInWithGoogleCredential, startGoogleLogin, getLastAccount, forgetLastAccount } from '../auth.js?v=dev101x-v73';
import { esc } from '../lib/html.js?v=dev101x-v73';
import { avatarFor, showToast, openModal } from '../ui.js?v=dev101x-v73';
import { PUBLIC_COURSES } from '../lib/public-courses.js?v=dev101x-v73';
import { UPCOMING } from '../lib/upcoming.js?v=dev101x-v73';
import { courseIcon } from '../lib/ranks.js?v=dev101x-v73';
import { courseLogo } from '../lib/course-logos.js?v=dev101x-v73';
import { showLoader, hideLoader } from './loader.js?v=dev101x-v73';
