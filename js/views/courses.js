...
import { COURSE, COURSE_OBJECTIVES, COURSE_VIDEO, LAB_STEPS, NMAP_RESOURCES } from '../content.js?v=dev101x-v55';
import { TOTAL_LESSONS } from '../lab.js?v=dev101x-v55';
import { currentProgress, fetchStreak } from '../progress.js?v=dev101x-v55';
import { fetchCourses, fetchCourseProgress, fetchCourseContent, requestCourseAccess, fetchAccessRequests } from '../cloud.js?v=dev101x-v55';
import { computeCourseProgress } from '../lib/course-engine.js?v=dev101x-v55';
import { openDialog, showToast } from '../ui.js?v=dev101x-v55';
import { UPCOMING } from '../lib/upcoming.js?v=dev101x-v55';
import { paintResume } from './resume.js?v=dev101x-v55';
