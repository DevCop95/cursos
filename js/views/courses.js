...
import { appState } from '../state.js?v=dev101x-v46';
import { COURSE, COURSE_OBJECTIVES, COURSE_VIDEO, LAB_STEPS, NMAP_RESOURCES } from '../content.js?v=dev101x-v46';
import { TOTAL_LESSONS } from '../lab.js?v=dev101x-v46';
import { currentProgress, fetchStreak } from '../progress.js?v=dev101x-v46';
import { fetchCourses, fetchCourseProgress, fetchCourseContent } from '../cloud.js?v=dev101x-v46';
import { computeCourseProgress } from '../lib/course-engine.js?v=dev101x-v46';
import { openDialog } from '../ui.js?v=dev101x-v46';
