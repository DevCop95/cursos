...
import { COURSE, COURSE_OBJECTIVES, COURSE_VIDEO, LAB_STEPS, NMAP_RESOURCES } from '../content.js?v=dev101x-v75';
import { TOTAL_LESSONS } from '../lab.js?v=dev101x-v75';
import { currentProgress, fetchStreak } from '../progress.js?v=dev101x-v75';
import { fetchCourses, fetchCourseProgress, fetchCourseContent, requestCourseAccess, fetchAccessRequests } from '../cloud.js?v=dev101x-v75';
import { computeCourseProgress } from '../lib/course-engine.js?v=dev101x-v75';
import { openDialog, showToast } from '../ui.js?v=dev101x-v75';
