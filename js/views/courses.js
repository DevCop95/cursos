...
import { COURSE, COURSE_OBJECTIVES, COURSE_VIDEO, LAB_STEPS, NMAP_RESOURCES } from '../content.js?v=dev101x-v60';
import { TOTAL_LESSONS } from '../lab.js?v=dev101x-v60';
import { currentProgress, fetchStreak } from '../progress.js?v=dev101x-v60';
import { fetchCourses, fetchCourseProgress, fetchCourseContent, requestCourseAccess, fetchAccessRequests } from '../cloud.js?v=dev101x-v60';
import { computeCourseProgress } from '../lib/course-engine.js?v=dev101x-v60';
import { openDialog, showToast } from '../ui.js?v=dev101x-v60';
import { UPCOMING } from '../lib/upcoming.js?v=dev101x-v60';
import { paintResume } from './resume.js?v=dev101x-v60';
