 ...
 */
import { appState, isSessionValid } from './state.js?v=dev101x-v72';
import { resolveRoute } from './router.js?v=dev101x-v72';
import { isAdmin, logout, revalidateSession, takeOAuthRedirect, completeOAuthRedirect, takeNewCourseAccess, checkNewCourseAccess } from './auth.js?v=dev101x-v72';
import { showToast, closeModal, avatarFor } from './ui.js?v=dev101x-v72';
import { initSearch, openSearch, closeSearch } from './search.js?v=dev101x-v72';
import { renderLogin, setLoginStatus, loginWithGoogle, forgetAccount } from './views/login.js?v=dev101x-v72';
import { renderMisCursos, renderExplorar, openCourseDetail, openDbCourseDetail, requestAccess } from './views/courses.js?v=dev101x-v72';
import { renderPerfil, openAccountDetails, openNameDialog, submitName } from './views/perfil.js?v=dev101x-v72';
import { createHistory } from './lib/cmd-history.js?v=dev101x-v72';
import { COURSE } from './content.js?v=dev101x-v72';
import { fetchCourses } from './cloud.js?v=dev101x-v72';
import { rememberLastCourse } from './views/resume.js?v=dev101x-v72';
import { openMessages, submitMessage, submitAdminReply, updateCounter, refreshUnreadMessages } from './views/messages.js?v=dev101x-v72';
import { startPresence } from './progress.js?v=dev101x-v72';
import { scheduleRankCheck } from './views/rank-notice.js?v=dev101x-v72';
import { showLoader, hideLoader } from './views/loader.js?v=dev101x-v72';
...
const aulaView = lazy(() => import('./views/aula.js?v=dev101x-v72'));
const courseView = lazy(() => import('./views/course-aula.js?v=dev101x-v72'));
const adminView = lazy(() => import('./views/admin.js?v=dev101x-v72'));
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=dev101x-v72').catch(() => {}));
