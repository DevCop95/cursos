 ...
 */
import { appState, isSessionValid } from './state.js?v=dev101x-v52';
import { resolveRoute } from './router.js?v=dev101x-v52';
import { isAdmin, logout, revalidateSession, takeOAuthRedirect, completeOAuthRedirect, takeNewCourseAccess, checkNewCourseAccess } from './auth.js?v=dev101x-v52';
import { showToast, closeModal, avatarFor } from './ui.js?v=dev101x-v52';
import { initSearch, openSearch, closeSearch } from './search.js?v=dev101x-v52';
import { renderLogin, setLoginStatus, loginWithGoogle, forgetAccount } from './views/login.js?v=dev101x-v52';
import { renderMisCursos, renderExplorar, openCourseDetail, openDbCourseDetail, requestAccess } from './views/courses.js?v=dev101x-v52';
import { renderAula, executeCommand, selectExplanation, switchNmapCategory, openLesson, openVideo, seekVideo, openResources, submitQuiz, onNoteInput, openCheatSheet, printCheatSheet, openHint } from './views/aula.js?v=dev101x-v52';
import { renderPerfil, openAccountDetails } from './views/perfil.js?v=dev101x-v52';
import { createHistory } from './lib/cmd-history.js?v=dev101x-v52';
import { renderCourseAula, runCourseCmd, runCourseCmdFromUi, openCourseLesson, openCourseVideo, seekCourseVideo, openCourseHint, openCourseCheatSheet, openCourseResources, selectCourseExplanation, resetCourseLab, submitCourseQuiz, setCourseTerminalMode, resetLinuxLab } from './views/course-aula.js?v=dev101x-v52';
import { COURSE } from './content.js?v=dev101x-v52';
import { renderAdmin, exportCsv, setAdminFilter, openUserDetails, setAccessLevel, setCourseOverride, setCourseFlag, resetUserProgress, answerAccessRequest, openThread, openRevokeDialog, confirmRevoke } from './views/admin.js?v=dev101x-v52';
import { fetchCourses } from './cloud.js?v=dev101x-v52';
import { rememberLastCourse } from './views/resume.js?v=dev101x-v52';
import { openMessages, submitMessage, submitAdminReply, updateCounter, refreshUnreadMessages } from './views/messages.js?v=dev101x-v52';
import { startPresence } from './progress.js?v=dev101x-v52';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=dev101x-v52').catch(() => {}));
