...
import { resolveRoute } from './router.js?v=dev101x-v76';
import { isAdmin, logout, revalidateSession, takeOAuthRedirect, completeOAuthRedirect, takeNewCourseAccess, checkNewCourseAccess } from './auth.js?v=dev101x-v76';
import { showToast, closeModal, avatarFor } from './ui.js?v=dev101x-v76';
import { initSearch, openSearch, closeSearch } from './search.js?v=dev101x-v76';
import { renderLogin, setLoginStatus, loginWithGoogle, forgetAccount } from './views/login.js?v=dev101x-v76';
import { renderMisCursos, renderExplorar, openCourseDetail, openDbCourseDetail, requestAccess } from './views/courses.js?v=dev101x-v76';
import { renderPerfil, openAccountDetails, openNameDialog, submitName } from './views/perfil.js?v=dev101x-v76';
import { createHistory } from './lib/cmd-history.js?v=dev101x-v76';
import { COURSE } from './content.js?v=dev101x-v76';
import { fetchCourses } from './cloud.js?v=dev101x-v76';
import { rememberLastCourse } from './views/resume.js?v=dev101x-v76';
import { openMessages, submitMessage, submitAdminReply, updateCounter, refreshUnreadMessages } from './views/messages.js?v=dev101x-v76';
import { startPresence } from './progress.js?v=dev101x-v76';
import { scheduleRankCheck } from './views/rank-notice.js?v=dev101x-v76';
import { showLoader, hideLoader } from './views/loader.js?v=dev101x-v76';
...
const aulaView = lazy(() => import('./views/aula.js?v=dev101x-v76'));
const courseView = lazy(() => import('./views/course-aula.js?v=dev101x-v76'));
const adminView = lazy(() => import('./views/admin.js?v=dev101x-v76'));
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=dev101x-v76').catch(() => {}));
